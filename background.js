...
//                     // Send the audio blob to the server for translation
//                     _this.sendAudioToServer(data.blob);
//             }
//         }
//         this.worker.postMessage({
//             command: "init",
...
//         .then(translatedBlob => {
//             // Create a URL for the translated audio and save it or use it as needed
//             const translatedAudioURL = URL.createObjectURL(translatedBlob);
//             console.log("Translated Audio URL: ", translatedAudioURL);
//             // You can now use the translatedAudioURL to play or save the translated audio
//             let audio = new Audio(translatedAudioURL);
//             audio.play();
//         })
...
// // sends responses to and from the popup menu
